...
Para mi la mas facil de comprender es Java ya que como venimos aprendiendo desde el primer ciclo este lenguaje, su sintaxis se hace muy comprensiva y facil de entender.
...
```
Realizamos en programacion estructural el codigo en:
Scala
```scala
...
```
Ahora en programacion funcional:
